...
SYMBOL      = "BTCUSD#"
TIMEFRAME   = 15
BARS        = 1920        # ~20 hari M15 (20 * 96)
INITIAL_BAL = 1000.0
LOT_SIZE    = 0.01        # Tetapkan 0.01 lot atau biarkan custom? Kita pakai lot 0.01
LEVERAGE    = 200
CONTRACT    = 1.0         # BTCUSD# contract size dari symbol info adalah 1.0
...
for i in range(WARMUP, len(cl) - 1):
    # Margin check BTCUSD# (lot * contract * price) / leverage
...
print(f"\n{'='*54}")
print(f"  BACKTEST  {SYMBOL}  M15  ~20 Hari  Leverage 1:{LEVERAGE}")
print(f"{'='*54}")
