...
- Max Daily Drawdown: 5% (Stop trade harian jika tercapai)
...
print(f"\n{'='*70}")
print(f"  USDCAD SCALPER - 1% RISK PER TRADE & MAX 5% DAILY DD")
print(f"  Modal Awal: ${INITIAL_BAL}  Leverage: 1:{LEVERAGE}")
print(f"{'='*70}")
for r in results:
